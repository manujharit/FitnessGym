    ...
    return (
        <div id="contactus" className="flex flex-row w-full my-[5%] px-[10%] xl:px-[5%]">
            <div className="w-[100%] xl:w-[70%] flex flex-col xl:pr-[5%]">
                ...
                <input type="text" className="w-[100%] lg:w-[70%] rounded-lg mt-[2%] bg-rose-300 text-black font-semibold placeholder-white focus:bg-blue-200 focus:outline-none focus:placeholder-transparent" placeholder="EMAIL" value={email} onChange={(event) => handleChange(event, 'email')} />
                <textarea type="text" rows='5' className="w-[100%] lg:w-[70%] rounded-lg mt-[2%] bg-rose-300 text-black font-semibold placeholder-white focus:bg-blue-200 focus:outline-none focus:placeholder-transparent" placeholder="MESSAGE" value={message} onChange={(event) => handleChange(event, 'message')} />
                <button className="w-[30%] xl:w-[15%] px-[3%] border rounded-lg bg-yellow-400 py-[1%] mt-[3%] hover:border hover:shadow-md hover:" onClick={()=>{handleClick()}}>SUBMIT</button>
            </div>
